...
const template = document.getElementById("folder-row-template");
function generateId() {
...
function createFolderItem(node) {
    const fragment = document.importNode(template.content, true);
    const item = fragment.querySelector(".folder-item");
    const toggleBtn = fragment.querySelector(".toggle-btn");
    const folderLabel = fragment.querySelector(".folder-label");
...
function renameFolder(nodeId, title) {
